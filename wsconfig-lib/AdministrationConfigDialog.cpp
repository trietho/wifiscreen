...
void AdministrationConfigDialog::initControls()
{
  ...
  m_openLogPathButton.setEnabled(false);
  m_setControlPasswordButton.setEnabled(false);
  m_unsetControlPasswordButton.setEnabled(false);
  m_useControlAuth.setEnabled(false);
  m_repeatControlAuth.setEnabled(false);
  ...
  m_shared[2].setEnabled(false);
  m_shared[3].setEnabled(false);
  m_shared[4].setEnabled(false);
  ...
  m_disconnectAction[0].setEnabled(false);
  m_disconnectAction[1].setEnabled(false);
  m_disconnectAction[2].setEnabled(false);

  m_logForAllUsers.setWindow(GetDlgItem(hwnd, IDC_LOG_FOR_ALL_USERS));
  m_logForAllUsers.setEnabled(false);

  m_logSpin.setWindow(GetDlgItem(hwnd, IDC_LOG_LEVEL_SPIN));
  m_logSpin.setEnabled(false);
