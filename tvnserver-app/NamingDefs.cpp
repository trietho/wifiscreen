...
const TCHAR ProductNames::PRODUCT_NAME[] = _T("WifiScreen");
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("WifiScreen Server");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\WifiScreen\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\WifiScreen\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\WifiScreen\\Control\\DispatcherConnectionHistory");

const TCHAR WindowNames::WINDOW_CLASS_NAME[] =
  _T("WifiScreenWindowsApplicationClass");

const TCHAR LogNames::SERVER_LOG_FILE_STUB_NAME[] = _T("wifiscreen");
const TCHAR LogNames::VIEWER_LOG_FILE_STUB_NAME[] = _T("tvnviewer");
const TCHAR LogNames::LOG_DIR_NAME[] = _T("WifiScreen");
const TCHAR LogNames::LOG_PIPE_PUBLIC_NAME[] = _T("WifiScreen_log_pipe_public_name");
const TCHAR LogNames::WIN_EVENT_PROVIDER_NAME[] = _T("wifiscreen");

const TCHAR ClipboardNames::CLIPBOARD_WIN_CLASS_NAME[] = 
  _T("WifiScreen.Clipboard.MessageWindow");


const TCHAR ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME[] =
  _T("wifiscreencontrol");
const TCHAR ServiceNames::SERVICE_NAME[] = _T("wifiscreen");
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("WifiScreen Server");

const TCHAR ServerApplicationNames::SERVER_INSTANCE_MUTEX_NAME[] =
  _T("wifiscreenApplication");
const TCHAR ServerApplicationNames::CONTROL_APP_INSTANCE_MUTEX_NAME[] =
  _T("wifiscreenServiceControlSlave");
const TCHAR ServerApplicationNames::FOR_SERVICE_CONTROL_APP_PIPE_NAME[] =
  _T("WifiScreen_Service_Control");
const TCHAR ServerApplicationNames::FOR_APP_CONTROL_APP_SERVICE_PIPE_NAME[] =
  _T("WifiScreen_Application_Control");
...
const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("WifiScreen Server");
